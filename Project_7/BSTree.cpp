 ...
 * 
 * If current Left is not NULL, the function will call itself with current -> left passed as the parameter.
 * Cout the current dataItem key. 
 * If current right is not NULL, the function will calltself with current -> right passed as the parameter.
 *
